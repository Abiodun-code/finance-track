...
const FirstName = ({ navigation }: NOT_AUTH_PROP) => {
  return (
    <Container padX={hp(2)} bgColor={Colors.black}>
      <ScrollView contentContainerStyle={{ paddingVertical: hp(2) }}>
        ...
        <View style={{ paddingTop: hp(2) }}>
          <CustomInput label='FirstName' bg={Colors.white} textColor={Colors.white} activeOutlineColor={Colors.white} bgColor={Colors.black} />

          <Button bg={Colors.blue} p={hp(1.7)} borderR={hp(2)} press={() => navigation.navigate(NOT_AUTHENTICATED_PATH.LastName)}>
